...
def handle_cmd_add(contacts_dictionary, contact_name, phone_number):
    ...
    contact_added_string = f"{contact_name} was saved with phone number {phone_number}."
...
def handle_cmd_edit(contacts_dictionary, contact_name, new_phone_number):
    ...
    contact_edited_string = f"Phone number for {contact_name} was changed from {old_phone_number} to {new_phone_number}."
...
def handle_cmd_phone(contacts_dictionary, contact_name):
    ...
    contact_phone_string = f"Phone number for {contact_name} is {phone_number}."
